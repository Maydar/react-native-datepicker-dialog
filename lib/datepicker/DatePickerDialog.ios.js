            ...
            <View style={{flexDirection:'row'}}>
              <View style={styles.modalContent}>
                <View style={{marginTop: 24, marginLeft: 8, marginRight:8}}>
                  ...
                  />
                  <View style={{flexDirection: 'row'}}>
                    <TouchableHighlight style={{flex:1}} onPress={this.cancel.bind(this)} underlayColor={"transparent"}>
                      <View style={{}}><Text style={styles.buttonTextStyle}>{this.props.cancelLabel}</Text></View>
                    </TouchableHighlight>
                    <TouchableHighlight style={{flex:1}} onPress={this.ok.bind(this)} underlayColor={"transparent"}>
